 ...
 *       
 * 
 * <p>Clase Java para service-ref_handler-chainsType complex type.
 * 
...
public class ServiceRefHandlerChainsType {
    ...
    protected List<ServiceRefHandlerChainType> handlerChains;
     ...
     * This is why there is not a <CODE>set</CODE> method for the handlerChains property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHandlerChains().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ServiceRefHandlerChainType> getHandlerChains() {
        if (handlerChains == null) {
            handlerChains = new ArrayList<ServiceRefHandlerChainType>();
        }
