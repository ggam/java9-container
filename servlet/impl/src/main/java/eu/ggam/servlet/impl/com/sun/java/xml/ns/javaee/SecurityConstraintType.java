...
public class SecurityConstraintType {
    ...
    protected List<WebResourceCollectionType> webResourceCollections;
    ...
    /**
     * Gets the value of the webResourceCollections property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the webResourceCollections property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getWebResourceCollections().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<WebResourceCollectionType> getWebResourceCollections() {
        if (webResourceCollections == null) {
            webResourceCollections = new ArrayList<WebResourceCollectionType>();
        }
