...
public class ServiceRefHandlerType {
    ...
    protected List<com.sun.java.xml.ns.javaee.String> soapRoles;
    @XmlElement(name = "port-name")
    protected List<com.sun.java.xml.ns.javaee.String> portNames;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the soapRoles property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * 
     */
    public List<com.sun.java.xml.ns.javaee.String> getSoapRoles() {
        if (soapRoles == null) {
            soapRoles = new ArrayList<com.sun.java.xml.ns.javaee.String>();
        }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the portNames property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * 
     */
    public List<com.sun.java.xml.ns.javaee.String> getPortNames() {
        if (portNames == null) {
            portNames = new ArrayList<com.sun.java.xml.ns.javaee.String>();
        }
