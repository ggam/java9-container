...
public class ServiceRefHandlerType {
    ...
    protected eu.ggam.container.impl.servletcontainer.com.sun.java.xml.ns.javaee.String handlerName;
    ...
    protected List<eu.ggam.container.impl.servletcontainer.com.sun.java.xml.ns.javaee.String> soapRoles;
    @XmlElement(name = "port-name")
    protected List<eu.ggam.container.impl.servletcontainer.com.sun.java.xml.ns.javaee.String> portNames;
     ...
     *     
     */
    public eu.ggam.container.impl.servletcontainer.com.sun.java.xml.ns.javaee.String getHandlerName() {
        return handlerName;
    }
     ...
     *     
     */
    public void setHandlerName(eu.ggam.container.impl.servletcontainer.com.sun.java.xml.ns.javaee.String value) {
     ...
     * 
     */
    public List<eu.ggam.container.impl.servletcontainer.com.sun.java.xml.ns.javaee.String> getSoapRoles() {
        if (soapRoles == null) {
            soapRoles = new ArrayList<eu.ggam.container.impl.servletcontainer.com.sun.java.xml.ns.javaee.String>();
        }
     ...
     * 
     */
    public List<eu.ggam.container.impl.servletcontainer.com.sun.java.xml.ns.javaee.String> getPortNames() {
        if (portNames == null) {
            portNames = new ArrayList<eu.ggam.container.impl.servletcontainer.com.sun.java.xml.ns.javaee.String>();
        }
